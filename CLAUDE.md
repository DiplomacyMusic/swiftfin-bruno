...
checkout, the current worktree, or unmerged/dirty work), then deletes DerivedData folders whose source
project no longer exists. **Defaults to `--dry-run`** (prints what it would remove + reclaimed sizes,
