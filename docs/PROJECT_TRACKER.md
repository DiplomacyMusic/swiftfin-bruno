...
| [ ] | On-device shelf check (focus feel, scroll-jump landing) | Home / Collections / Genres | Wants a real Apple TV pass (focus feel can't be driven headlessly in the sim). **Now also covers the new §7 cinematic `BrunoBrandHeroBand` drill-ins (`ce925ac1`)** — they mirror shipped Studios structure but sim focus timing differs. |
